...
475	SameSite=Strict cookie not sent cross-site	\N	block	critical	44	1	sameSiteCookieTest(475, true, "strict", "critical")	t
476	SameSite=Lax cookie not sent cross-site subresource	\N	block	critical	44	2	sameSiteCookieTest(476, true, "lax", "critical")	t
